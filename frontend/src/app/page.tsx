        ...
        <main className="mt-6 grid grid-cols-1 md:grid-cols-3 gap-6">
          <motion.div initial={{ opacity: 0, y: 6 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.05 }}>
            <Card>
              ...
              <p className="text-sm text-[var(--color-muted)]">A code-first canvas for designers and developers — tokens, components, and Storybook included.</p>
              <div className="mt-4 flex gap-3">
                <Button variant="primary" onClick={() => alert('Starter scaffold — open Storybook to explore components')}>Get started</Button>
                <Button onClick={() => alert('Use Copy component to copy example code to clipboard')}>Copy example</Button>
              </div>
            </Card>
          ...
          <motion.div initial={{ opacity: 0, y: 6 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.12 }}>
            ...
            <Card className="mt-4">
              ...
              <ol className="text-sm text-[var(--color-muted)] list-decimal list-inside space-y-2">
                ...
                <li>Click "Export tokens" to copy CSS tokens to your clipboard and download a tokens.json file (useful for importing into token pipelines).</li>
                <li>Use "Copy component" to copy a ready-to-paste TypeScript React component to your clipboard so you can paste it into your codebase.</li>
